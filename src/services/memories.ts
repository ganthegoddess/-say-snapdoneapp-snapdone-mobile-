...
import type { MemoryPayload, AskPipResponse } from "../types";
...
/**
 * Ask PIP a natural-language question to search memories.
 *
 * POST /api/v1/memories/ask
 */
export async function askPip(query: string): Promise<AskPipResponse> {
  return post<AskPipResponse>(MEMORIES.ASK, { query });
}
